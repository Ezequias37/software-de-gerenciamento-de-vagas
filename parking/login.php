            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.php" class="logo d-flex align-items-center w-auto">
                  <span class="d-none d-lg-block">Reservas de Estacionamento</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Faça login da sua conta</h5>
                  ...
                  ?>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Não tem uma conta? <a href="cadastro.php">Cadastre-se</a></p>
                    </div>
                  </form>
